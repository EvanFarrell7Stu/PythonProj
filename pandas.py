...
#sets size of chunk to read
chunk_size = 100_000
#chunks[] is a list(like an array)
chunks = []
 
#pandas reads csv in chunks
for chunk in pd.read_csv(
    csv_path,
    encoding="latin1",
    low_memory=False,
    chunksize=chunk_size,
    on_bad_lines='skip',#skips no data lines
    #lambda is an "inline function"
    usecols=lambda c: c in ['BerRating', 'CountyName'] #column headings
):
...
#function for converting number to grade unnecessary but good to know
